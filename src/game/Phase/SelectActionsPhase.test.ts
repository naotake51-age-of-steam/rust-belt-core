...
test('actionSelectAction', () => {
  b
    ...
    .setPlayers([
      ...
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 2, 2, 10)
    ])
    .setPhase(new SelectActionsPhase())
...
test('actionSelectAction 最終プレイヤーの場合は次のフェーズに進む', () => {
  b
    ...
    .setPlayers([
      ...
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10),
      new Player(2, '00000000-0000-0000-0000-000000000003', Action.FIRST_BUILD, 2, 2, 10)
    ])
    .setPhase(new SelectActionsPhase())
    .setTurnPlayer(new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
