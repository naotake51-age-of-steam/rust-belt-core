...
test('minBids', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 2, 10, 0, 1),
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1)
    ])
...
test('maxBids', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 2, 15, 0, 1),
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1)
    ])
    .setPhase(new DeterminePlayerOrderPhase([
...
test('canBids タープレイヤーが最低ビット金額を持っていたらTrue', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 2, 6, 0, 1),
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1)
    ])
    .setPhase(new DeterminePlayerOrderPhase([
...
test('canBids タープレイヤーが最低ビット金額を持っていなかったらFalse', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 2, 5, 0, 1),
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1)
    ])
    .setPhase(new DeterminePlayerOrderPhase([
...
test('actionDropout 4人プレイヤー中の1番目のユーザーが降りた場合', () => {
  b
    ...
    .setPlayers([
      ...
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1),
      new Player(3, '00000000-0000-0000-0000-000000000004', null, 4, 2, 10, 0, 1)
    ])
    .setPhase(new DeterminePlayerOrderPhase([
      new PlayerBid(0, 3, false, null),
      new PlayerBid(1, 4, false, null),
...
test('actionDropout 4人プレイヤー中の2番目のユーザーが降りた場合', () => {
  b
    ...
    .setTurnPlayer(new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1))
...
test('actionDropout 4人プレイヤー中の3番目のユーザーが降りた場合', () => {
  b
    ...
    .setTurnPlayer(new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1))
...
test('actionDropout 次のプレイヤーがすでに降りている場合は、その次のプレイヤー手番がくる（プレイヤーの順序がid順でないパターンも確認）', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 2, 10, 0, 1),
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 4, 2, 10, 0, 1), // 4番手
      new Player(3, '00000000-0000-0000-0000-000000000004', null, 3, 2, 10, 0, 1) // 3番手
    ])
    .setPhase(new DeterminePlayerOrderPhase([
      new PlayerBid(0, 3, false, null),
      new PlayerBid(1, 5, false, 3),
