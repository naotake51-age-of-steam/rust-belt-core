...
test('maxIssueShares', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 4, 10, 0, 1),
...
test('canIssueShares 株式発行上限に達していない場合はTrue', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 14, 10, 0, 1),
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1)
    ])
    .setPhase(new IssueSharesPhase())
...
test('canIssueShares 株式発行上限に達している場合はFalse', () => {
  b
    ...
    .setPlayers([
      new Player(0, '00000000-0000-0000-0000-000000000001', null, 1, 15, 10, 0, 1),
      new Player(1, '00000000-0000-0000-0000-000000000002', null, 2, 2, 10, 0, 1),
      new Player(2, '00000000-0000-0000-0000-000000000003', null, 3, 2, 10, 0, 1)
    ])
    .setPhase(new IssueSharesPhase())
