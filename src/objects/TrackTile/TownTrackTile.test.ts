  ...
  t(
    ...
    function () {
      ...
      g = b
        ...
        .setLineOwner(trackTiles[53].lines[0], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .setLineOwner(trackTiles[53].lines[1], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .build()
