  ...
  t(
    ...
    function () {
      ...
      g = b
        ...
        .placeTrackTileToMapSpace(trackTiles[52], getMapSpace(s(0, 1)), 3)
        .setLineOwner(trackTiles[52].lines[0], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .setLineOwner(trackTiles[52].lines[1], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .placeTrackTileToMapSpace(trackTiles[53], getMapSpace(s(1, 0)), 0)
        .placeTrackTileToMapSpace(trackTiles[119], getMapSpace(s(1, 1)), 5)
        .setLineOwner(trackTiles[119].lines[0], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .setLineOwner(trackTiles[119].lines[1], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .placeTrackTileToMapSpace(trackTiles[111], getMapSpace(s(2, 1)), 0)
        .build()
  ...
  t(
    ...
    function () {
      ...
      g = b
        ...
        .placeTrackTileToMapSpace(trackTiles[111], getMapSpace(s(1, 0)), 1)
        .setLineOwner(trackTiles[111].lines[0], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .setLineOwner(trackTiles[111].lines[1], new Player(1, '00000000-0000-0000-0000-000000000002', null, 3, 2, 10))
        .build()
